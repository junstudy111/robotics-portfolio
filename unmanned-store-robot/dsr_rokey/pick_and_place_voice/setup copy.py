...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'segmentation_service = object_detection.segmentation_service:main',  # ← 추가!
            ...
            'get_keyword_v7 = voice_processing.get_keyword_v7:main',
            'get_keyword_js = voice_processing.get_keyword_js:main',
            'fastapi_server = web.fastapi_server:main',
            'api_server_ws = voice_processing.fastapi_server_ws:main',
